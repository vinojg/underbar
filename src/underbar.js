(function() {
  ...
  _.reject = function(collection, test) {
    ...
    return _.filter(collection, function(opposite) {
      return !test(opposite);
    });
  };
...
_.reduce = function(collection, iterator, accumulator){
  _.each(collection, function(item){
    if(accumulator === undefined) {
      ...
      var iteratedValue = iterator(accumulator, item);
      if (iteratedValue===undefined) {
        return accumulator;
      } else {
        return accumulator = iteratedValue;
      }
    } 
  });
  return accumulator;
  ...
  _.shuffle = function(array) {
    var elements = array.slice(0,array.length);
    var shuffledArray = [];
